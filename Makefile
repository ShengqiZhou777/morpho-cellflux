...
train:
	OUT=outputs/perturbmulti_run bash scripts/train.sh

train-diet:
	OUT=outputs/diet_run CONFIG=diet_id_v3 DATASET=diet_id bash scripts/train.sh
...
smoke:
	OUT=outputs/smoke NPROC=1 BATCH=4 EPOCHS=1 EVAL_FREQ=1000 FID_SAMPLES=16 \
